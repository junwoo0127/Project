<template>
  <div class="Nowplayinghome">
    <h1 class="title">
      <br>
      <span>Now Playing</span>      
    </h1>
    <div class='scratch--outer'>
    ...
    <br>
    <br>
    <div class="NowPlayingMovieHome">
      <now-playing-movie-card v-for="movie in nowplaying" :key="movie.pk" :movie="movie"></now-playing-movie-card>
    </div>
  </div>
</template>
